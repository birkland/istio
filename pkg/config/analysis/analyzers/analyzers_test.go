...
import (
	...
	"istio.io/istio/123/pkg/config/analysis/analyzers/annotations"
	"istio.io/istio/123/pkg/config/analysis/analyzers/authz"
	"istio.io/istio/123/pkg/config/analysis/analyzers/deployment"
	"istio.io/istio/123/pkg/config/analysis/analyzers/deprecation"
	"istio.io/istio/123/pkg/config/analysis/analyzers/destinationrule"
	"istio.io/istio/123/pkg/config/analysis/analyzers/envoyfilter"
	"istio.io/istio/123/pkg/config/analysis/analyzers/externalcontrolplane"
	"istio.io/istio/123/pkg/config/analysis/analyzers/gateway"
	"istio.io/istio/123/pkg/config/analysis/analyzers/injection"
	"istio.io/istio/123/pkg/config/analysis/analyzers/k8sgateway"
	"istio.io/istio/123/pkg/config/analysis/analyzers/maturity"
	"istio.io/istio/123/pkg/config/analysis/analyzers/multicluster"
	schemaValidation "istio.io/istio/123/pkg/config/analysis/analyzers/schema"
	"istio.io/istio/123/pkg/config/analysis/analyzers/service"
	"istio.io/istio/123/pkg/config/analysis/analyzers/serviceentry"
	"istio.io/istio/123/pkg/config/analysis/analyzers/sidecar"
	"istio.io/istio/123/pkg/config/analysis/analyzers/telemetry"
	"istio.io/istio/123/pkg/config/analysis/analyzers/virtualservice"
